...
<%def name="sidebox_1()">
  <section>
    ...
    ${h.link_to(_("Options"), url(controller='admin', action='options'))}<br/>
    ${h.image("/images/page_white_world.png", alt=_("Access log"))}
    ${h.link_to(_("Access log"), url(controller='admin', action='accesslog'))}<br/>
    ${h.image("/images/page_white_error.png", alt=_("Error log"))}
    ${h.link_to(_("Error log"), url(controller='admin', action='errorlog'))}<br/>
