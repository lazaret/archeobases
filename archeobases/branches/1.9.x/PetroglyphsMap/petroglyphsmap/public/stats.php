...
if ($scale == 'Zone') {
    ...
    $typename = 'zones';
    $viewname = "zonestats".session_id(); // name of unique view to be created
    $mapname = "tmp/wfs_zonestats".session_id().".map"; // name of unique mapfile to be created
    ...
    */
    ...
    $map->setMetaData('wfs_onlineresource', 'http://127.0.0.1/cgi-bin/mapserv.exe?map=C:\ms4w\Apache\htdocs\tmp\wfs_'.$viewname.'.map'); // modifying the url value
    ...
    */
    ...
    $typename = 'rocks';
    $viewname = "rockstats".session_id(); // name of unique view to be created
    $mapname = "tmp/wfs_rockstats".session_id().".map"; // name of unique mapfile to be created
