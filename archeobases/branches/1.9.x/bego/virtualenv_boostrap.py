...
#!/usr/bin/env python
"""Create a "virtual" Python installation with packages required for our
Pylons projects building and testing.
"""
...
def after_install(options, home_dir):
    ...
    # project install
    print "=> Install bego 1.9.x"
    subprocess.call([join(home_dir, 'bin', 'easy_install'),
                    'http://lazaret.unice.fr/svn/archeobases/branches/1.9.x/bego/'])
    devnull.close()
