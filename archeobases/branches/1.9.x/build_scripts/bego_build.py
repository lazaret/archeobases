...
def install_deps():
    ...
    result = subprocess.call('env/bin/easy_install Pylons', shell=True, stdout=None, stderr=devnull)
    ...
    result = subprocess.call('env/bin/python Imaging-1.1.6/setup.py install', shell=True, stdout=None, stderr=devnull)
    devnull.close()
