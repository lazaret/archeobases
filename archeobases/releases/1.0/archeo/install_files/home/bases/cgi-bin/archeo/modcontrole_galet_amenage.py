...
#
#
# $Id: modcontrole_galet_amenage.py,v 1.4 2001/07/05 15:29:21 rachel Exp $
#
# $Log: modcontrole_galet_amenage.py,v $
...
page.insert_text(" Contrôles des champs de l'écran galets amenagés  ")
page.pop()
...
page.push()
cpt = 0
for chaine in ("ga_type","ga_facture","ga_qualite","ga_forme","ga_arete","ga_orientation","ga_retouche","ga_obliquite"):
        if (cpt == 6 ) :
                page.pop()
                page.push()
                page.tr()
