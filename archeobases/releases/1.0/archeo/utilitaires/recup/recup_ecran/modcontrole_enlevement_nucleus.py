...
#
#
# $Id: modcontrole_enlevement_nucleus.py,v 1.3 2001/07/05 15:29:20 rachel Exp $
#
# $Log: modcontrole_enlevement_nucleus.py,v $
# Revision 1.3  2001/07/05 15:29:20  rachel
# plein de modifs
#
...
page.insert_text(" Contrôles des champs de l'écran des enlèvements sur nucléus")
page.pop()
...
page.push()
cpt = 0
for chaine in ("en_obliquite", "en_dptimpact", "en_profondeur", "en_frappe", "en_inclinaison", "en_direction"):
        if (cpt == 6 ) :
                page.pop()
                page.push()
                page.tr()
