...
#
#
# $Id: modcontrole_fracture_industrie.py,v 1.1 2001/07/17 14:05:16 rachel Exp $
#
# $Log: modcontrole_fracture_industrie.py,v $
...
page.push()
cpt = 0
for chaine in ("fi_type", "fi_percussion", "fi_mode"):
        if (cpt == 6 ) :
                page.pop()
                page.push()
                page.tr()
