...
#
#
# $Id: modcontrole_stigmate.py,v 1.3 2001/07/05 15:29:25 rachel Exp $
#
# $Log: modcontrole_stigmate.py,v $
# Revision 1.3  2001/07/05 15:29:25  rachel
# plein de modifs
#
...
page.insert_text(" Contrôles des champs de l'écran Stigmates  ")
page.pop()
...
page.push()
cpt = 0
for chaine in ("s_ordre", "s_type","s_sous_type", "s_lustrage", "s_polissage","s_localisation", "s_situation", "s_relation"):
        if (cpt == 6 ) :
                page.pop()
                page.push()
                page.tr()
