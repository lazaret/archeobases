...
def display_field(key, champ, enregistrement):
    ...
    link = None
    linkeys = annuaireconf.linkeys # clefs pour lesquelles on veut un lien vers un ecran
...
if ruser not in annuaireconf.visitorusers:
            ...
            if (resultat != None) and (type(resultat) != type(0)):
                ...
                if nbrecords:
                    ...
                    if form["presentation"].value == telechargecsv:
                        ...
                        csv_file = open("/home/bases/annuaire/resultat_requete.csv", "wb")
                    ...
                    if form["presentation"].value == telechargexls:
                        ...
                        xls_sheet = xls_file.add_sheet("requete_"+annuaireconf.base_courante)
                        # defaut cell style
                        ...
                        # save the file and post the file for download
                        xls_file.save("/home/bases/annuaire/resultat_requete.xls")
                        doc.set_redirect("http://"+hostname+"/annuaire/resultat_requete.xls")
                    # display HTML results
                        ...
                        if form["presentation"].value == elabore:
                            ...
                            for champ in liste_champs:
                                doc.th(champ, bgcolor=annuaireconf.bas1_bgcolor)
                            doc.pop()
                            ...
                            for enregistrement in dict_valeurs: # enregistrement est un dictionnaire
                                ...
                                for key in liste_champs:
                                    ...
                                    doc.td(align="left", bgcolor=annuaireconf.bas1_bgcolor)
