...
#
#
# $Id: modcontrole_galet.py,v 1.3 2001/07/05 15:29:21 rachel Exp $
#
# $Log: modcontrole_galet.py,v $
# Revision 1.3  2001/07/05 15:29:21  rachel
# plein de modifs
#
...
page.insert_text(" Contrôles des champs de l'écran galet  ")
page.pop()
