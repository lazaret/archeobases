...
#                self.__doc__.pop()
        ...
        def  profondeur_base_to_form(self, enreg, penreg = None) :
                ...
                self.__doc__.td(align="left", valign="middle", colspan="2")
                self.__doc__.font(size=begoconf.font_size)
                liste={"SR Superficielle & Régulière": "SR", "SI Superficielle & Irrégulière": "SI","PPR Peu Profonde & Régulière": "PPR", "PPI Peu Profonde & Irégulières": "PPI","PR Profonde & Régulière" : "PR","PI Profonde et Irrégulière":"PI","TPR Très Profonde & Régulière" : "TPR", "TPI Très Profonde & Irrégulière":"TPI"}
