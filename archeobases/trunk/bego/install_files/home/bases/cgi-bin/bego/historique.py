    ...
    def liste_photohistorique(self, enreg):
        ...
        if lg:
            ...
            for photo in resp:
                ...
                xmax, ymax = begoconf.get_imagesize(begoconf.image_fullname("Z" + `enreg["zone"]` + os.sep + "G" + `enreg["groupe"]` + os.sep + "R" +  enreg["roche"] + os.sep + "F" + enreg["face"] + os.sep + "H" + enreg["historique"] + os.sep + `photo["idphoto"]` + "s.jpg"))
