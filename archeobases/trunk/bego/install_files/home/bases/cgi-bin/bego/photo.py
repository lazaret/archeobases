...
""" Module qui modifie/supprime/transfere les photos sur le serveur
et met à jour la base de donnée
"""
...
class Photo(begodata.Data):
    ...
    def creer(self):
        ...
        try:
            ...
            self.__db__.query(self.make_insert_query({"idphoto": str(idphoto)}))
        self.retour()
