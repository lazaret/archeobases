...
def ajoute_ligne_vide(objet, hauteur, nb):
    """ Ajoute une ligne vide dans un tableau."""
    objet.__doc__.push()
    objet.__doc__.tr()
    objet.__doc__.push()
    objet.__doc__.td(colspan=nb, height=hauteur)
...
def display_zone(objet, enreg, penreg=None, alignement="right"):
    """ Affiche la zone ou la liste des zones."""
    objet.__doc__.push()
...
def display_zone_photo(doc, enreg, penreg = None, alignement = "right"):
    """ Affiche la zone ou la liste des zones. Utilisé seulement pour les photos"""
    doc.push()
...
def display_groupe(objet, enreg, penreg=None, alignement="right"):
    """ Affiche le groupe ou la liste des groupes."""
    objet.__doc__.push()
    objet.__doc__.td(align=alignement, valign="middle", border="0")
    objet.__doc__.b()
    objet.__doc__.font(size=begoconf.font_size)
...
def display_roche(objet, enreg, penreg=None, alignement="right"):
    """ Affiche la roche ou la liste des roches."""
    objet.__doc__.push()
    objet.__doc__.td(align=alignement, valign="middle", border="0")
    objet.__doc__.b()
    objet.__doc__.font(size=begoconf.font_size)
...
def display_face(objet, enreg, penreg=None, alignement="right"):
    """ Affiche la face ou la liste des faces."""
    objet.__doc__.push()
    objet.__doc__.td(align=alignement, valign="middle", border="0")
    objet.__doc__.b()
    objet.__doc__.font(size=begoconf.font_size)
...
def display_association(doc, enreg, penreg=None, alignement="right"):
    """ Affiche un champ pour le numéro d'association."""
    doc.push()
    doc.td(align=alignement, valign="middle")
    doc.b()
    doc.font(size=begoconf.font_size)
...
def display_figure(doc, enreg, penreg=None, alignement="center"):
    """ Affiche un champ pour le numéro de figure proto-historique."""
    doc.push()
    doc.td(align=alignement, valign="middle")
    doc.b()
    doc.font(size=begoconf.font_size)
...
def display_historique(doc, enreg, penreg=None, alignement="center"):
    """ Affiche un champ pour le numéro de figure historique."""
    doc.push()
    doc.td(align=alignement, valign="middle")
    doc.b()
    doc.font(size=begoconf.font_size)
...
def display_field_photo(doc, enreg, field="", alignement="right"):
    """ Affiche la valeur d'un champ sans modifications possible.
    Utilisé seulement pour les photos."""
    doc.td(align=alignement, width="20%", bgcolor="#FFFFFF")
    doc.b()
    doc.font(size=begoconf.font_size)
    doc.insert_text("&nbsp;"+field.capitalize()+"&nbsp;:&nbsp;"+enreg[field]+"&nbsp;")
    doc.hidden(name=field, value=enreg[field])
