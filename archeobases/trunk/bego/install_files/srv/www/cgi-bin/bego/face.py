...
class Face(begodata.Data):
    ...
    def couleur_base_to_form(self, enreg, penreg=None):
        ...
        self.__doc__.td(align="left", valign="middle")
        self.__doc__.font(size=begoconf.font_size)
        listecouleurs = {"B Blanc": "B", "G Gris": "G", "VE VErt": "VE", "O Orange": "O", "BR BRun": "BR",
            "RO ROse": "RO", "R Rouge": "R", "VI VIolet": "VI", "GO Gris Orangé": "GO", "GR Gris Rouge": "GR",
            "GVE Gris VErt": "GVE", "GVI Gris VIolet": "GVI"}
    ...
    def orientation_base_to_form(self, enreg, penreg=None):
        ...
        listeorientations = {"NS": "NS", "SN": "SN", "EW": "EW", "WE": "WE", "NWSE": "NWSE", "NESW": "NESW",
            "SWNE": "SWNE", "SENW": "SENW"}
    ...
    def liste_photoface(self, enreg):
        ...
        if lg:
            ...
            for photo in resp:
                ...
                xmax, ymax = begoconf.get_imagesize(begoconf.image_fullname("Z" + `enreg["zone"]` + os.sep + "G" + `enreg["groupe"]` + os.sep + "R" +  enreg["roche"] + os.sep + "F" +  enreg["face"] + os.sep + `photo["idphoto"]` + "s.jpg"))
