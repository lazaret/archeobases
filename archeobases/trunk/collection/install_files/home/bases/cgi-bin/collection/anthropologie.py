...
################################### En entrée ###########################
        ...
        def m_groupe_base_to_form(self, enreg, penreg = None) :
                self.__doc__.push()
                afficheclefs.champ_saisie(self, "m_groupe", "Groupe", 30, 30, " ", enreg, penreg)
                self.__doc__.pop()

        def m_etagere_base_to_form(self, enreg, penreg = None) :
                self.__doc__.push()
                afficheclefs.champ_saisie(self, "m_etagere", "Etagère", 4, 4, " ", enreg, penreg)
                self.__doc__.pop()
        ...
        def m_date_base_to_form(self, enreg, penreg = None) :
                self.__doc__.push()
                afficheclefs.champ_saisie(self, "m_date", "Date moulage", 4, 4, " ", enreg, penreg)
                self.__doc__.pop()
        ...
        def m_donnateur_base_to_form(self, enreg, penreg = None) :
                self.__doc__.push()
                afficheclefs.champ_saisie(self, "m_donnateur", "Donateur", 30, 30, " ", enreg, penreg)
                self.__doc__.pop()
