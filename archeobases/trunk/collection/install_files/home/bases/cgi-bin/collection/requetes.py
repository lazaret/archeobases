...
def display_field(key, champ, enregistrement):
    ...
    link = None
    linkeys = collectionconf.linkeys # clefs pour lesquelles on veut un lien vers un ecran
            ...
            if (resultat != None) and (type(resultat) != type(0)):
                ...
                if nbrecords:
                    ...
                    if form["presentation"].value == telechargecsv:
                        ...
                        csv_file.close()
                        if not os.path.exists("/srv/www/default/collection/resultat_requete.csv"):
                            os.symlink("/tmp/resultat_requete.csv", "/srv/www/default/collection/resultat_requete.csv")
                    ...
                    if form["presentation"].value == telechargexls:
                        ...
                        if not os.path.exists("/srv/www/default/collection/resultat_requete.xls"):
                            os.symlink("/tmp/resultat_requete.xls", "/srv/www/default/collection/resultat_requete.xls")
                        ...
                        if form["presentation"].value == elabore:
                            ...
                            for enregistrement in dict_valeurs: # enregistrement est un dictionnaire
                                ...
                                for key in liste_champs:
                                    ...
                                    doc.td(align="left", bgcolor=collectionconf.bas1_bgcolor)
