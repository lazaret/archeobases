...
class Objets_archeologiques(collectiondata.Data):
    #
    # le nom de la table
    __tablename__ = "objets_archeologiques"
    ...
    __listechamps__ = ("identifiant", "m_type_materiel", "m_type_support", "m_nom_familier", "m_nom_site", "m_numero_inventaire",
                       ...
                       "m_origine", "m_date_acquisition", "m_moul_orig", "m_depot_moule", "m_observations",
                       "m_mots_clefs", "m_nombre_exemplaires", "m_date_modif")
    # liste des champs dans leur ordre de saisie
    __ordrechamps__ = ("identifiant", "m_type_materiel", "m_type_support", "m_nom_familier", "m_nom_site", "m_numero_inventaire",
                       "m_age_absolu", "m_ville", "m_region", "m_pays", "m_periode_culturelle", "m_individu",
                       "m_depot_original", "m_description_anatomique", "m_date_decouverte", "m_inventeur",
                       "m_origine", "m_date_acquisition", "m_moul_orig", "m_depot_moule", "m_observations",
